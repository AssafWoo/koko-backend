...
exports.calculateRelativeTime = exports.normalizeSchedule = void 0;
const normalizeSchedule = (schedule, currentTime, currentDate, prompt) => {
    ...
    if (prompt.toLowerCase().includes('in ') &&
        ...
        const calculatedTime = (0, exports.calculateRelativeTime)(currentTime, prompt);
