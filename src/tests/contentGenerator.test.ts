import { generateContent } from '../server/services/contentGenerator';

describe('Content Generator Tests', () => {
  test('should generate facts about AI', async () => {
    const facts = await generateContent('facts', {
  ...
  test('should generate learning content about Python', async () => {
    const learningContent = await generateContent('learning', {
